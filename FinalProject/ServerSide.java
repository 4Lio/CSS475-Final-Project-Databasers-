...
public class ServerSide {
    ...
    private boolean AddDrink(params) {
    ...
    private boolean UpdateDrinkPrice(params) {
    ...
    private boolean UpdateDrinkStatus(params) {
    ...
    private boolean AddMember(params) {
    ...
    private boolean AddShipment(params) {
    ...
    private boolean AddDrinkToShipment(params) {
    ...
    private boolean ShipmentArrived(params) {
    ...
    private boolean MoveStock(params) {
    ...
    private boolean GetMemberSales(params) {
    ...
    private boolean CancelSale(params) {
    ...
    private boolean MakePurchase(params) {
    ...
    private boolean FindMostProfitableMonth(params) {
